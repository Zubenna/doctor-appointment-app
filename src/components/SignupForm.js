...
const SignupForm = ({
  ...
  <form onSubmit={handleSubmit}>
    <input type="text" placeholder="Enter full name" name="full_name" value={full_name} onChange={handleChange} />
    <br />
    <input type="text" placeholder="Enter username" name="username" value={username} onChange={handleChange} />
    <br />
    <input type="text" placeholder="Phone number" name="phone_number" value={phone_number} onChange={handleChange} />
    <br />
    ...
    <br />
    <input type="password" placeholder="Enter password" name="password_digest" value={password_digest} onChange={handleChange} />
    <br />
